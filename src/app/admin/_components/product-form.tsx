...
import { addProductAction, updateProductAction } from "../_actions/products";
        ...
        <form action={action} className="space-y-8">
            ...
            <div className="space-y-2">
                ...
                <div className="text-muted-foreground">
                    {formatCurrency((priceInPaise || 0) / 100)}
                </div>
                {error?.priceInPaise && (
                    <div className="text-destructive">{error.priceInPaise}</div>
                )}
            </div>
            <div className="space-y-2">
